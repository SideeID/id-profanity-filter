...
export const betawi: ProfanityWord[] = [
  {
    ...
    description:
      'Singkatan dari "jarang dibelai", istilah untuk perempuan yang mudah didekati',
  ...
  },
  {
    ...
    context:
      "Hinaan untuk menyebut orang yang dianggap tidak modern atau kampungan",
  },
  {
    word: "perek",
    category: "sexual",
    ...
    description:
      "Istilah untuk perempuan yang dianggap memiliki moral yang rendah",
    context: "Hinaan yang merendahkan untuk wanita",
  },
];
